...
"&pl="+_A(_pl)+_hbSendEV();if(_D("onlyMedia")!="y")_hbi.src=_ar+"&hid="+Math.random();_hbq=_IS(_ar,0,_II(_ar,"&hec"));_hbE=_NA()}
//DOL Added Code to remove HBX tracking

//emtpy out all HBX functions used
...
function _hbPageView(p,m){}function _hbExitLink(n){}function _hbDownload(n){}
function _hbVisitorSeg(n,p,m){}function _hbCampaign(n,p,m){}
function _hbFunnel(n,p,m){}function _hbGoalPage(n,p,m){}
